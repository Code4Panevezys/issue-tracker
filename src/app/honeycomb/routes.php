...
{
    Route::get('issues', ['as' => 'admin.issues', 'middleware' => ['acl:opendata_lt_issue_tracker_issues_list'], 'uses' => 'ODIssuesController@adminView']);

    Route::group(['prefix' => 'api'], function ()
    {
        Route::get('issues', ['as' => 'admin.api.issues', 'middleware' => ['acl:opendata_lt_issue_tracker_issues_list'], 'uses' => 'ODIssuesController@pageData']);
        Route::get('issues/list', ['as' => 'admin.api.issues.list', 'middleware' => ['acl:opendata_lt_issue_tracker_issues_list'], 'uses' => 'ODIssuesController@list']);
        Route::get('issues/search', ['as' => 'admin.api.issues.search', 'middleware' => ['acl:opendata_lt_issue_tracker_issues_list'], 'uses' => 'ODIssuesController@search']);
        Route::get('issues/{id}', ['as' => 'admin.api.issues.single', 'middleware' => ['acl:opendata_lt_issue_tracker_issues_list'], 'uses' => 'ODIssuesController@getSingleRecord']);
